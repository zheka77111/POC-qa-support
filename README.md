...
Проект демонстрирует PoC мультиагентной обработки обращений в техподдержку. Ядром является langchain react агент. Такой подход позволяет в дальнейшем подключать различные модули в виде skills, долгосрочную память и поддержку работы с файлами, различные планировщики и подрезка контекста и др.
